...
public final class DateUtil {
	...
	private static final SimpleDateFormat NORMAL_DATE_FORMAT_YY_MM_DD = new SimpleDateFormat(
			"yyyy-MM-dd");
	private static final SimpleDateFormat NORMAL_DATE_FORMAT_YY_MM_DD_ = new SimpleDateFormat(
			"yyyyMMdd");

	private static final SimpleDateFormat NORMAL_DATE_FORMAT_YYMMDDHHMISS = new SimpleDateFormat(
			"yyyyMMddHHmmss");
	...
	public static long getFirstDayOfMonth(String year, String month) {
		...
		return parseDate(
				NORMAL_DATE_FORMAT_YY_MM_DD.format(cal.getTime()) + " 00:00:00")
				.getTime() / 1000;
	}
	...
	public static long getLastDayOfMonth(String year, String month) {
		...
		return parseDate(
				NORMAL_DATE_FORMAT_YY_MM_DD.format(cal.getTime()) + " 23:59:59")
				.getTime() / 1000;
	}
	...
	public static Date parseDateYMD(String dateStr) {
		try {
			return NORMAL_DATE_FORMAT_YY_MM_DD.parse(dateStr);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static long parseLongYMD(String date) {
		return parseDateYMD(date).getTime() / 1000;
	}
	...
	public static long getTime(long time) {
		...
		timeCalendar.set(Calendar.HOUR_OF_DAY,
		...
		timeCalendar.set(Calendar.MILLISECOND,
				nowCalendar.get(Calendar.MILLISECOND));
